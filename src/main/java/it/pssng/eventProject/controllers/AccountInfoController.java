...
public class AccountInfoController {
    ...
    public ResponseEntity<LoggedProfileInfoDTO> retrievePromoterInfo(@PathVariable String fiscalCode)
            throws UserNotFoundException {
        try {
            LoggedProfileInfoDTO fetchedData = loggedProfileInfoService.getProfileData(fiscalCode);
